...
const TERRAIN_LEGEND: Record<TerrainKind, LegendEntry> = {
  ...
  tide: { label: 'Tide', color: '#1f5f9e', effect: 'Surging ocean — very heavy slow and slow drowning damage.' },
  abyss: { label: 'Abyss', color: '#7b5cff', effect: 'A black chasm — heavy damage; the void drags at your steps.' },
};
