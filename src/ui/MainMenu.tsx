  ...
  return (
    <div className="wb-screen">
      <div className="wb-panel wb-menu-panel" ref={panelRef}>
        ...
        <p className="wb-tagline">Gather a warband. Slay the boss. No server required.</p>

        <div className="wb-menu-actions">
          <button type="button" className="wb-btn wb-btn-primary wb-btn-lg" onClick={goHost}>
            Host Game
          </button>
          <button type="button" className="wb-btn wb-btn-primary wb-btn-lg" onClick={goJoin}>
            Join Game
          </button>
        </div>
        ...
        <p className="wb-blurb">
          Warband is a cooperative boss fight that runs entirely in your browser. One player{' '}
          <strong>hosts</strong> the fight, shares a link with friends, and everyone connects
          peer-to-peer over WebRTC. There is no game server and nothing to install — close the tab
