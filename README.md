...
- **Grand improvements & bot progression** — each class has rare, transformative **grand improvements** (unique capstones you can hold only once) that surface as a prized pick. AI band members now **progress their power** between bosses just like the humans — personality shapes their choices (a Reckless bot hoards damage, a Timid one stacks health).
